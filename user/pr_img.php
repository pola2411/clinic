...
if(isset($_GET['add'])){
    ...
    $s="SELECT * FROM `prescription_image` WHERE user_id=$id_user";
    ...
    if(isset($_POST['send'])){
        ...
        $i="INSERT INTO `prescription_image`(`id`, `image`, `user_id`, `date`) VALUES (NULL,'$image_name',$id_user,default)";
...
<main id="main">
  <section id="about" class="about">
    <div class="container col-md-8">
      <div class="card ">
        <h1>Add New prescription_image</h1>
        <div class="card-body">
